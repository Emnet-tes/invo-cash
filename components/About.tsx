...
export default function About() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-blue-800 via-[#0a021a] to-black py-20 px-6 md:px-12" id="about">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[400px] md:h-[500px] flex items-center justify-center">
          ...
          {/* Orbit Circles */}
          <div className="absolute w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full border border-white/10" />
          <div className="absolute w-[280px] h-[280px] md:w-[350px] md:h-[350px] rounded-full border border-white/10" />
          <div className="absolute w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-full border border-white/10" />

          {/* Floating Avatars */}
          {people.map((p, i) => (
            <div
              key={i}
              className={`absolute ${p.pos} w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden shadow-lg shadow-blue-500 ring-2 ring-blue-500/50`}
            >
        ...
        <div className="text-white space-y-6">
          <span className="px-4 py-1 text-sm font-medium bg-blue-700 rounded-full">
            About Us
          </span>
