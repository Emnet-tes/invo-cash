...
export default function Solution() {
  return (
    <section className="bg-slate-50 text-black py-16 px-6" id="solution">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Card 1 */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16 bg-white rounded-2xl p-6 border border-gray-200 shadow-md ">
          <div>
        ...
        {/* Card 2 */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-white rounded-2xl p-6 border border-gray-200 shadow-md">
